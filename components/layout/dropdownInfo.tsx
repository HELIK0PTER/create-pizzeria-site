    ...
    >
      <div className="bg-white shadow-lg rounded-r-lg p-3 relative border border-gray-100">
        <button
          ...
          className="p-5 absolute -right-5.5 top-1/2 -translate-y-1/2 rounded-full"
        >
          <div
            className="absolute right-1/2 top-1/2 translate-x-1/2 -translate-y-1/2 bg-white rounded-full p-1 shadow-md hover:cursor-pointer
